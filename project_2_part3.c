...
Queue *emergencyPadAQueue;
Queue *emergencyPadBQueue;
...
pthread_mutex_t emergencyPadAQueueMutex;
pthread_mutex_t emergencyPadBQueueMutex;
...
int main(int argc,char **argv) {
    ...
    */
    ...
    emergencyPadAQueue = ConstructQueue(1000);
    emergencyPadBQueue = ConstructQueue(1000);
    ...
    pthread_t emergencyPadAThread;
    pthread_t emergencyPadBThread;
    ...
    pthread_mutex_init(&emergencyPadAQueueMutex, NULL);
    pthread_mutex_init(&emergencyPadBQueueMutex, NULL);
    ...
    pthread_create(&emergencyPadAThread, NULL, PadA, NULL);
    pthread_create(&emergencyPadBThread, NULL, PadB, NULL);
    ...
    DestructQueue(emergencyPadAQueue);
    DestructQueue(emergencyPadBQueue);
